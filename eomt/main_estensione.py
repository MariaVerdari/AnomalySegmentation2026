...
class LightningCLI(cli.LightningCLI):
    ...
    def add_arguments_to_parser(self, parser):
        ...
        # Evita che il parser fallisca se la classe del modello non richiede esplicitamente stuff_classes
        parser.link_arguments(
            "data.init_args.stuff_classes", 
            "model.init_args.stuff_classes",
            apply_on="parse"
        )
